...
<div class="container mx-auto mt-5 px-4">
    ...
    <form method="POST" action="{{ route('vehicles.store') }}" onsubmit="handleSubmit(event)">
        @csrf
        <input type="hidden" name="origem" value="Motorez">
        <div class="bg-white mx-auto shadow-md rounded-lg p-4 w-3/5">
            <h1 class="text-2xl">Novo Veículo</h1>
            ...
            <div class="grid grid-cols-3 gap-2">
                <div class="mb-4">
                    ...
                    <input
                        ...
                        id="marca" type="text" name="marca" required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        id="modelo" type="text" name="modelo" required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        id="ano" type="number" name="ano" required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <select style="background-color: white !important;"
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        id="combustivel" type="text" name="combustivel" required>
                ...
                <div class="mb-4">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        id="km" type="number" name="km" required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        id="preco" type="number" name="preco" required>
                </div>
            </div>
            <div class="mt-6 flex items-center justify-start gap-x-6">
                <a href="{{ route('vehicles.index') }}">Voltar</a>
                <button type="submit"
                    class="bg-blue-700 hover:bg-blue-900 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Criar</button>
            </div>
        </div>
    </form>
</div>

<script src="{{ asset('js/createVehicles.js') }}"></script>
@endsection